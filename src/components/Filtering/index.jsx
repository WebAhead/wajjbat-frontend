      ...
      <div className="filtersContainer">
        <div className="filterByBusinessTypeContainer">
          ...
          <DropDownList
            ...
            onChange={({ value }) =>
              filterByTypeHandler({ value: typeOptions.filter((item) => item.label === value)[0].value })
            }
          />
        </div>
        ...
        <div className="filterByCuisineTypeContainer">
          ...
          <DropDownList
            ...
            onChange={({ value }) =>
              filterByCuisineHandler({ value: cuisineOptions.filter((item) => item.label === value)[0].value })
            }
          />
        </div>
